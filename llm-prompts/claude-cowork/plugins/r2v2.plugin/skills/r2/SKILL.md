...
description: >
  ...
  to the correct anansi or r2v2 skill: raw documents and knowledge → r2v2:r2-remember
...
| **Quick named entity or whisper** | Single person, org, event, project, passing mention | `anansi:anansi-atom` |
| **Bulk server-side ingest** | Large file, fire-and-forget to Anansi | `anansi:anansi-ingest-file` |
| **Knowledge search or recall** | "What do I know about X", "pull context on Y" | `anansi:anansi-recall` |
...
- Never call `anansi_*` tools directly. All Anansi writes go through anansi skills.
